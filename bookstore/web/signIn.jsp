<%-- 
    Document   : signIn
    Created on : 17.11.2012, 18:57:50
    Author     : alex
--%>
    ...
    <body>
        ...
        <div class="main_part_page">
            ...
            <div class="main_page_text">
                <br> 
                <br> 
                <center>   <form class="form-container" method=get action="signIn" >
                    ...
                    <font size="2">    <a href="registration.jsp" >I have no accaunt. Registaration</a> </font>
