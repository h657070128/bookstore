<%-- 
    Document   : addBook
    Created on : 30.11.2012, 23:41:54
    Author     : alex
--%>
    ...
    <body>
        <div class="main_part_page">
            ...
            <div class="main_page_text">
                ...
                <form name="name" action="../addBookServlet">
                    name </br>
                    ...
                    price </br>
                    <input type="text" name="price" value="" onkeypress='validate(event)'/> </br>
                    rate </br>
                    <input type="text" name="rate" value="" onkeypress='validate(event)'/> </br>
